...
셋 중 무엇으로도 확인되지 않은 브랜치는 **어디에도 보고되지 않습니다.** 의도된 동작입니다 — squash 가 흡수하면서 커밋 제목을 새로 쓴 경우 따라갈 근거가 남지 않는데, 추측으로 "완료"라고 적는 것은 빠뜨리는 것보다 나쁩니다. 이름 없는 반영 건들은 같은 창(기본 7일) 안에서 그대로 함께 보고되므로, 작업 자체가 사라지는 것이 아니라 브랜치와의 연결만 빠집니다.
